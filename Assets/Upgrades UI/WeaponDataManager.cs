...
public class WeaponDataManager : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        CurrentAmmoConsumption = _upgradesData.startingAmmoConsumption;
    ...
    public void UpgradeAmmoConsumption() => CurrentAmmoConsumption += _upgradesData.ammoConsumptionUpgradeStep;
